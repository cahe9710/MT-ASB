function [cl cd cm] = naca0018(alfa)
   
%  alfa = -pi:0.01:pi; [cl cd cm] = naca0018(alfa); figure(1); plot(rad2deg(alfa),cl,'g',rad2deg(alfa),cd,'r',rad2deg(alfa),cm,'m');grid on;zoom on;
